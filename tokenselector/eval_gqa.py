...
def eval_single_gqa(args):
    ...
    for qid, prediction in tqdm(predictions.items()):
...
if __name__ == "__mian__":
    ...
    parser.add_argument('--questions',      default="val__questions.json", type = str,    help = "Questions file name format.")
    parser.add_argument('--choices',        default="val_choices.json",       type = str,    help = "Choices file name format.")
    parser.add_argument('--predictions',    default="val_predictions.json",   type = str,    help = "Answers file name format.")
    parser.add_argument('--attentions',     default="val_attentions.json",    type = str,    help = "Attentions file name format.")
